...
data class Account(
    ...
    @Id @Column(name = "username") val username: String = UUID.randomUUID().toString(),
    @Column(name = "confirmation_id", unique = true) val confirmationId: String = UUID.randomUUID().toString()
) {
