...
data class OpenGrantedAuthority(val teamId: Int, val roles: Set<TeamMember.Role>) : GrantedAuthority {
    ...
    companion object {
        ...
        fun toAuthority(s: String): OpenGrantedAuthority {
            ...
            return OpenGrantedAuthority(split[0].toInt(), roles.map { TeamMember.Role.valueOf(it) }.toSet())
        }
    }
}